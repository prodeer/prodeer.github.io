...
category: mq
tags: ["消息队列", "通信协议"]
description: "和车打交道后，接触到了`MQTT`，第一次听到这个词时，我还疑心自己是不是听错了，问Leader是不是`MQ`，得到了“不是”的答复，遂有此文，总结一下我所了解的`MQTT`。    ## 一、MQT..."
---
...
![Mermaid 图表](/images/mermaid/mermaid-2c5c905e-0.svg)
