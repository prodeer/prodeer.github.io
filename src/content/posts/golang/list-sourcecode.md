...
description: "刷力扣时，有这样一道题，要求**设计并实现一个满足  LRU (最近最少使用) 缓存约束的数据结构**，实现这道题用到了Go 官方库提供的`container/list`包中的List（双向链表）。..."
---
...
![Mermaid 图表](/images/mermaid/mermaid-55af484e-0.svg)
