...
category: golang
tags: ["Golang", "源代码"]
description: "Go 中的 map 是一种内置的数据结构，它实现了哈希表的特性，可以存储键值对。本篇文章学习map的底层结构和扩容机制。   map 的相关部分可以在源码下的 `runtime/map.go` 文件中..."
---
...
![map底层结构](/images/map-substructure.png "map底层结构")
