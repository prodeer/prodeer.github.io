...
description: "Eino 同时有 Chain 和 Graph，都能编排流程。Chain 解决的是“固定流程编排”，Graph 解决的是“动态智能系统运行”。理解两者的边界，是理解 Agent Runtime 架构的关..."
---
...
![Mermaid 图表](/images/mermaid/mermaid-fc2930b7-0.svg)
