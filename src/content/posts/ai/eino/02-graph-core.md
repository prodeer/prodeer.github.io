...
description: "Graph 是 Eino 编排能力的核心，也是它对标 LangGraph 的招牌。如果说 Component 是 Eino 的“能力抽象”，那么 Graph 就是 Eino 的“运行时模型”。理解 G..."
---
...
![Mermaid 图表](/images/mermaid/mermaid-e635664f-0.svg)
...
![Mermaid 图表](/images/mermaid/mermaid-b07957c6-1.svg)
