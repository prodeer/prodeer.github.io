...
description: "如果说 Tool 让 Agent 具备“行动能力”，那么 Memory 让 Agent 具备“连续性”。没有 Memory 的 Agent，本质上只是一次性的函数调用；有 Memory 的 Agent..."
---
...
![Mermaid 图表](/images/mermaid/mermaid-62d276a3-0.svg)
