...
date: 2025-12-01
category: ai
tags: ["Eino", "Agent", "Agent 架构"]
description: "转组后要做技术分享，加上技术团队也一直反复强调拥抱 AI，借着这个机会，学习如何用 Go 原生的方式写 AI Agent，工具就是字节跳动开源的 **Eino**。    ## 1. 背景：LLM 应..."
---
...
![Mermaid 图表](/images/mermaid/mermaid-69c0059d-0.svg)
