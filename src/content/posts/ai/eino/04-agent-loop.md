...
description: "Agent 的核心不是“让 LLM 输出更聪明的文本”，而是让模型具备**感知、决策、执行、反馈、再决策**的闭环能力。本篇深入分析 Eino 中 Agent 的核心机制：Tool Calling、P..."
---
...
![Mermaid 图表](/images/mermaid/mermaid-2e823126-0.svg)
