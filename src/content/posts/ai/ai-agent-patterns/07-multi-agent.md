...
description: "一次软件发布评审同时涉及安全、性能和发布流程。让一个 Agent 在同一上下文里不断切换角色当然可行，但不同职责可能需要不同工具、权限和评价标准，也可能需要并行工作。  Multi-Agent 模式把..."
---
...
![Mermaid 图表](/images/mermaid/mermaid-acdb26ec-2.svg)
