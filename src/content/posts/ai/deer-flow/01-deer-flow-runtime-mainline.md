...
description: "刚开始读 DeerFlow 时，我一直在找“Agent 的主循环”到底写在哪。后来发现，这个问题本身就有偏差：DeerFlow 的核心不是某个巨大的循环，而是把一次请求变成一套配置明确、状态可恢复的运..."
---
...
![Mermaid 图表](/images/mermaid/mermaid-8aa12f43-0.svg)
