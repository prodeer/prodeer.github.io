...
description: "我最初关注子 Agent，是因为它看起来能并行完成更多工作。真正读到执行器和 `ThreadState` 后，我发现更难的问题不是启动任务，而是让父子任务共享必要环境、隔离各自对话，并把结果可靠地合回..."
---
...
![Mermaid 图表](/images/mermaid/mermaid-8866e31e-0.svg)
