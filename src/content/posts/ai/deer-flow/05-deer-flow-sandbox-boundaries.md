...
description: "看到 Sandbox 这个名字，我的第一反应是“代码会在隔离容器里运行”。但 DeerFlow 默认开发环境里的 `LocalSandbox` 并不是容器。它主要提供路径作用域、统一工具协议和命令治理..."
---
...
![Mermaid 图表](/images/mermaid/mermaid-b7963717-0.svg)
