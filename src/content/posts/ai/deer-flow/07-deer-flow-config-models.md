...
description: "多模型支持常被描述成“换一个模型名就能跑”。真正接入过不同 provider 后就会发现，差异不仅在 URL 和 API Key，还在 thinking 参数、工具调用消息、流式用量和 reasoni..."
---
...
![Mermaid 图表](/images/mermaid/mermaid-c6ab9af4-0.svg)
