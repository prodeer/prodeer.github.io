...
description: "“持久化 Agent”听起来像把对话存进数据库，但 DeerFlow 同时维护了几种不同寿命的信息。把它们混在一起，很容易误以为 checkpoint、Memory 和 Run 记录是在重复保存同一件..."
---
...
![Mermaid 图表](/images/mermaid/mermaid-57ecf212-0.svg)
