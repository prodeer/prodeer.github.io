...
description: "我以前写 Agent，习惯把所有要求都塞进 system prompt：工具怎么用、什么时候提问、哪些命令危险，似乎只要说明得足够完整，模型就会照做。DeerFlow 的实现让我意识到，这其实混淆了“..."
---
...
![Mermaid 图表](/images/mermaid/mermaid-fc97dddb-0.svg)
